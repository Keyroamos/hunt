...
class UserSerializer(serializers.ModelSerializer):
    ...
    has_paid_verification = serializers.SerializerMethodField()

    class Meta:
        model = User
        fields = ['id', 'username', 'email', 'phone', 'user_type', 'is_verified', 'is_staff', 'is_superuser', 'date_joined', 'password', 'full_name', 'verification_status', 'has_paid_verification']
    ...
    def get_verification_status(self, obj):
        try:
            return obj.verification_document.status
        except:
            return 'not_started'

    def get_has_paid_verification(self, obj):
        # Check if user has a completed payment for verification
        return Payment.objects.filter(user=obj, payment_type='verification', status='completed').exists()
...
class VerificationDocumentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'id_number', 'id_type', 'id_document', 'status', 'rejection_reason', 'uploaded_at', 'reviewed_at']
