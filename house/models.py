...
class Property(models.Model):
    ...
    bedrooms = models.IntegerField(validators=[MinValueValidator(0)], default=0, blank=True)
    bathrooms = models.IntegerField(validators=[MinValueValidator(0)], default=0, blank=True)
...
class VerificationDocument(models.Model):
    ...
    id_document = models.FileField(upload_to='verification_docs/')
